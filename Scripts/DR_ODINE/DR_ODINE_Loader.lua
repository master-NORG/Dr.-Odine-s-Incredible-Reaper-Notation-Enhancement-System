...
-- Loads maps into slots (0..N) and writes ArticMaps_Slots.ini (map->slot, instrument->map, instrument->slot)
----------------- CONFIG -----------------
...
local INI_PATH = ARTICMAPS_DIR .. "ArticMaps.ini"  
local SLOTS_PATH = ARTICMAPS_DIR .. "ArticMaps_Slots.ini"
local GMEM_NAME = "ArticMaps"
