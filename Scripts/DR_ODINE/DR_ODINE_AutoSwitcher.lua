...
-- @author DR_ODINE  
-- @version 1.0
-- @provides [main] DR_ODINE_AutoSwitcher.lua
-- @about
--   # DR_ODINE_AutoSwitcher
--   
--   Automatically switches between mapped and unmapped modes based on instrument presets.
--   Monitors tracks for preset changes and configures ArticMaps JSFX accordingly.
...
local SLOTS_PATH = ARTICMAPS_DIR .. "ArticMaps_Slots.ini"
local JSFX_NAME_MATCH      = "ArticMaps"      -- substring to find the Key Switch JSFX
...
if not REG then reaper.MB(ERR, "ArticMaps AutoSwitcher", 0) return end
